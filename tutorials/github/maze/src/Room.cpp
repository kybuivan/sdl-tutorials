...
Room::Room(Coordinate pos, SDL_Renderer *renderer) : roomPos(pos)
{
    ...
    {
        roomTextures[0b0000] =
            IMG_LoadTexture(roomRenderer, IMG_0BORDER); //None

        roomTextures[0b0001] =
            IMG_LoadTexture(roomRenderer, IMG_1BORDER_D); //Down
        roomTextures[0b0010] =
            IMG_LoadTexture(roomRenderer, IMG_1BORDER_L); //Left
        roomTextures[0b0100] =
            IMG_LoadTexture(roomRenderer, IMG_1BORDER_U); //Up
        roomTextures[0b1000] =
            IMG_LoadTexture(roomRenderer, IMG_1BORDER_R); //Right
...
Room::Room(const Room &other)
    : roomPos(other.roomPos), roomRect(other.roomRect),
      adjRooms(other.adjRooms), availRooms(other.availRooms),
