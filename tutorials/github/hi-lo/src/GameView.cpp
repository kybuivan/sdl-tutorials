...
static Rectangle const downButtonBounds{0,
                                        1632 - downButtonBottomOffset,
                                        540,
                                        288};

constexpr char const *upButtonTexturePath{"Assets/upButton.png"};
constexpr int upButtonBottomOffset{20};
static Rectangle const upButtonBounds{540,
                                      1632 - upButtonBottomOffset,
                                      540,
                                      288};
...
GameView::GameView() noexcept
    : mBackgroundSprite{loadTexture(backgroundSpriteTexturePath),
      ...
      mHighScoreTitleSprite{highScoreTitleText,
                            highScoreTitleColor,
                            highScoreTitleBounds},
      mHighScoreNumberSprite{highScoreNumberColor, highScoreNumberBounds},
      mCurrentScoreTitleSprite{currentScoreTitleText,
                               currentScoreTitleColor,
