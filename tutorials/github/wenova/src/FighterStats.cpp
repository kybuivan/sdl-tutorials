...
FighterStats::FighterStats(Fighter *p_fighter,
                           int p_index_fighter,
                           int p_side,
                           double p_x,
                           double p_y)
...
void FighterStats::update(float)
{
    if (fighter)
    {
        ...
        if (side == 0)
        {
            ...
            life[condition].set_clip(0,
                                     0,
                                     life[condition].get_width() *
                                         percent_to_draw_life,
        ...
        if (side == 1)
        {
            special[condition].set_clip(0,
                                        0,
                                        special[condition].get_width() *
                                            percent_to_draw_special,
                                        special[condition].get_height());
...
void FighterStats::render()
{
    ...
    int y_even_offset =
        is_ultimate_diff && condition == 2 && index_fighter % 2 == 0 ? 3 : 0;
    ...
    if (side == 0)
    {
        ...
        empty_bg[condition].render(82,
                                   box.get_draw_y() + 22 + offset +
                                       y_even_offset);
